...
<div class="modal-footer display">
	<div class="row">
		<div class="col-md-12">
			...
			<button class="btn float-right btn-basiccolor mr-2" type="button" id="payment">Payment</button>
			<?php if(strtotime(date('Y-m-d')) > strtotime($end_date)): ?>
			<button class="btn float-right btn-basiccolor mr-2" type="button" id="renew">Renew</button>
			<?php endif; ?>
			<button class="btn float-right btn-basiccolor mr-2" type="button" id="end">End Plan</button>
		</div>
	</div>
</div>
<style>
